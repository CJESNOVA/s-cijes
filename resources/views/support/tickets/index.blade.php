...
<header class="header" data-testid="header">
    <div class="header-content">
        <div class="header-left">
            ...
            <p class="page-subtitle">Gérer et suivre tous les tickets de support</p>
        </div>
...
<div class="filters-container" data-testid="filters-container">
    <form method="GET" action="{{ route('tickets.index') }}" class="w-full">
        ...
        <div class="filters-row">
            ...
            <select name="module_id" class="filter-select" data-testid="filter-module">
            ...
            <button type="button" onclick="window.location.href='{{ route('tickets.index') }}'" class="btn btn-secondary" data-testid="clear-filters">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <table class="tickets-table">
        <thead>
            <tr>
                ...
                <th data-testid="th-user">Utilisateur</th>
            ...
            <tr class="table-row" data-testid="ticket-row">
                ...
                <td class="ticket-user">
                    <div class="user-cell">
                        ...
                        <span>{{ $ticket->user->nom }} {{ $ticket->user->prenom }}</span>
                    </div>
                </td>
                <td>
